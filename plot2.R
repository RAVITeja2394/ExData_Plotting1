...
#Plot of Global Active power and datetime variables

png(file="C:\\Users\\Ravi\\Desktop\\Coursera_assignment1\\EDA1\\Power\\plot2.png",
    width=480, height=480)

plot(x = hpc$date_time,y = as.numeric(hpc$Global_active_power),type = "l",
